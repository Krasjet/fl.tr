...
module Text.Pandoc.Fltr.LaTeX.PostProcessors (getBaseline, postProcessSVG) where
...
getBaseline = getBaseline' . skipTo viewboxMarker

-- | A helper function for actually retrieving the baseline
getBaseline' :: Text -> Double
getBaseline' sfx = error "TODO"
  -- case P.parse parser "<input>" sfx of
